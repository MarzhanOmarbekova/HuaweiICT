  ...
  return (
    <header style={{
      ...
      <div>
        ...
        {subtitle && <p style={{ fontSize: '11px', color: 'var(--text-muted)', fontFamily: 'var(--font-mono)' }}>{subtitle}</p>}
      </div>
      ...
      {balance && (
        <div style={{
          ...
          <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
            ...
            <span style={{ color: 'var(--text-muted)', marginLeft: '3px', fontSize: '11px' }}>kWh</span>
          </span>
