    ...
    <div className="animate-in">
      ...
      >
        ...
        <span style={{ color: "var(--text-secondary)" }}>
          ...
          <strong>Petal Maps</strong> + Open-Meteo wind data. Configure your
          Petal Maps key in{" "}
          <code
          ...
          {result && (
            <Card accent>
              ...
              {[
                ...
                {
                  label: "12 months",
                  val: result.predicted_energy["12_months"],
                },
              ].map((e) => (
                <div
                  key={e.label}
          ...
          {running && !result && (
            <Card>
              <div style={{ textAlign: "center", padding: "20px" }}>
                ...
                >
                  <div
                    style={{
                      ...
                      backgroundImage:
                        "linear-gradient(90deg, var(--accent) 25%, var(--accent-hover) 50%, var(--accent) 75%)",
                ...
                >
                  May take 30-60s (8x8 grid API calls)
                </p>
              </div>
            </Card>
          )}
      ...
      <Card>
        ...
        {histLoading ? (
          ...
          <EmptyState
            ...
            description="Run your first optimization above"
          />
        ) : (
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              ...
              <tbody>
                {history.map((h) => (
                    ...
                    >
                      <Badge
                        variant={h.status === "completed" ? "green" : "amber"}
                      >
                        {h.status}
                      </Badge>
                    </td>
